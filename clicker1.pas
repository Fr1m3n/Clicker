...
procedure TForm1.Button2Click(Sender: TObject);      // сила 1
begin
  inc(strength);
  label2.Caption := 'Strength - ' + inttostr(strength);
  label3.Caption := 'Auto Strength - ' + inttostr(strength_auto);
...
procedure TForm1.Button3Click(Sender: TObject);      // авто 1
begin
  inc(strength_auto);
  label2.Caption := 'Strength - ' + inttostr(strength);
  label3.Caption := 'Auto Strength - ' + inttostr(strength_auto);
...
procedure TForm1.Button4Click(Sender: TObject);       // сила 2
begin
  inc(strength, 2);
  label2.Caption := 'Strength - ' + inttostr(strength);
  label3.Caption := 'Auto Strength - ' + inttostr(strength_auto);
